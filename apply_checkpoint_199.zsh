...
files=(
  ...
  scripts/check_cp199_positive_definite_why.zsh
  scripts/render_cp199_positive_definite_why.zsh
  CHECKPOINT_199.md
)
...
chmod +x \
  "$target_root/scripts/check_cp199_positive_definite_why.zsh" \
  "$target_root/scripts/render_cp199_positive_definite_why.zsh"

print -- "Checkpoint 199 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp199_positive_definite_why.zsh"
