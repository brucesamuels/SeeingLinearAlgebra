...
files=(
  ...
  scripts/check_cp201_positive_definite_eigenvalue_test.zsh
  scripts/render_cp201_positive_definite_eigenvalue_test.zsh
  CHECKPOINT_201.md
)
...
chmod +x \
  "$target_root/scripts/check_cp201_positive_definite_eigenvalue_test.zsh" \
  "$target_root/scripts/render_cp201_positive_definite_eigenvalue_test.zsh"

print -- "Checkpoint 201 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp201_positive_definite_eigenvalue_test.zsh"
