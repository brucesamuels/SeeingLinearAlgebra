...
files=(
  ...
  scripts/check_cp204_positive_definite_cholesky.zsh
  scripts/render_cp204_positive_definite_cholesky.zsh
  CHECKPOINT_204.md
)
...
chmod +x \
  "$target_root/scripts/check_cp204_positive_definite_cholesky.zsh" \
  "$target_root/scripts/render_cp204_positive_definite_cholesky.zsh"

print -- "Checkpoint 204 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp204_positive_definite_cholesky.zsh"
