...
chmod +x \
  "$target_root/scripts/check_cp210_minimum_principle.zsh" \
  "$target_root/scripts/render_cp210_minimum_principle.zsh"

print -- "Checkpoint 210 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp210_minimum_principle.zsh"
