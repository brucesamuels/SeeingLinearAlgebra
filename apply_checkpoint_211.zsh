...
chmod +x \
  "$target_root/scripts/check_cp211_finite_element_energy.zsh" \
  "$target_root/scripts/render_cp211_finite_element_energy.zsh"

print -- "Checkpoint 211 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp211_finite_element_energy.zsh"
