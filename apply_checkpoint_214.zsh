...
chmod +x \
  "$target_root/scripts/build_cp214_positive_definite_master.py" \
  "$target_root/scripts/check_cp214_positive_definite_master.zsh" \
  "$target_root/scripts/render_cp214_positive_definite_master.zsh"

print -- "Checkpoint 214 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp214_positive_definite_master.zsh"
