...
cp "$bundle_root/apply_checkpoint_217.zsh" "$target_root/apply_checkpoint_217.zsh"
chmod +x \
  "$target_root/apply_checkpoint_217.zsh" \
  "$target_root/scripts/check_cp217_svd_pseudoinverse.zsh" \
  "$target_root/scripts/render_cp217_svd_pseudoinverse.zsh"

print -- "Checkpoint 217 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp217_svd_pseudoinverse.zsh"
