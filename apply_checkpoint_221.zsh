...
cp "$bundle_root/apply_checkpoint_221.zsh" "$target_root/apply_checkpoint_221.zsh"
chmod +x \
  "$target_root/apply_checkpoint_221.zsh" \
  "$target_root/scripts/check_cp221_svd_image_compression.zsh" \
  "$target_root/scripts/render_cp221_svd_image_compression.zsh"

print -- "Checkpoint 221 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp221_svd_image_compression.zsh"
