...
cp "$bundle_root/apply_checkpoint_222.zsh" "$target_root/apply_checkpoint_222.zsh"
chmod +x \
  "$target_root/apply_checkpoint_222.zsh" \
  "$target_root/scripts/check_cp222_pca_svd.zsh" \
  "$target_root/scripts/render_cp222_pca_svd.zsh"

print -- "Checkpoint 222 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp222_pca_svd.zsh"
