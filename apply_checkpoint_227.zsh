...
cp "$bundle_root/apply_checkpoint_227.zsh" "$target_root/apply_checkpoint_227.zsh"
chmod +x \
  "$target_root/apply_checkpoint_227.zsh" \
  "$target_root/scripts/check_cp227_graph_matrix_encoding.zsh" \
  "$target_root/scripts/render_cp227_graph_matrix_encoding.zsh"

print -- "Checkpoint 227 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp227_graph_matrix_encoding.zsh"
