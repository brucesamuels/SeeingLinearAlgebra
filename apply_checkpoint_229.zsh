...
cp "$bundle_root/apply_checkpoint_229.zsh" "$target_root/apply_checkpoint_229.zsh"
chmod +x \
  "$target_root/apply_checkpoint_229.zsh" \
  "$target_root/scripts/check_cp229_graph_incidence_encoding.zsh" \
  "$target_root/scripts/render_cp229_graph_incidence_encoding.zsh"

print -- "Checkpoint 229 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp229_graph_incidence_encoding.zsh"
