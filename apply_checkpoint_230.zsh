...
cp "$bundle_root/apply_checkpoint_230.zsh" "$target_root/apply_checkpoint_230.zsh"
chmod +x \
  "$target_root/apply_checkpoint_230.zsh" \
  "$target_root/scripts/check_cp230_graph_laplacian_operator.zsh" \
  "$target_root/scripts/render_cp230_graph_laplacian_operator.zsh"

print -- "Checkpoint 230 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp230_graph_laplacian_operator.zsh"
