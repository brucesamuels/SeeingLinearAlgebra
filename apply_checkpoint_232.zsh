...
cp "$bundle_root/apply_checkpoint_232.zsh" "$target_root/apply_checkpoint_232.zsh"
chmod +x \
  "$target_root/apply_checkpoint_232.zsh" \
  "$target_root/scripts/check_cp232_graph_laplacian_null_space.zsh" \
  "$target_root/scripts/render_cp232_graph_laplacian_null_space.zsh"

print -- "Checkpoint 232 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp232_graph_laplacian_null_space.zsh"
