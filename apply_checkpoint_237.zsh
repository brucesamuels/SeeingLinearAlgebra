...
cp "$bundle_root/apply_checkpoint_237.zsh" "$target_root/apply_checkpoint_237.zsh"
chmod +x \
  "$target_root/apply_checkpoint_237.zsh" \
  "$target_root/scripts/check_cp237_markov_long_term_behavior.zsh" \
  "$target_root/scripts/render_cp237_markov_long_term_behavior.zsh"

print -- "Checkpoint 237 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp237_markov_long_term_behavior.zsh"
