...
cp "$bundle_root/apply_checkpoint_238.zsh" "$target_root/apply_checkpoint_238.zsh"
chmod +x \
  "$target_root/apply_checkpoint_238.zsh" \
  "$target_root/scripts/check_cp238_directed_page_rank.zsh" \
  "$target_root/scripts/render_cp238_directed_page_rank.zsh"

print -- "Checkpoint 238 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp238_directed_page_rank.zsh"
