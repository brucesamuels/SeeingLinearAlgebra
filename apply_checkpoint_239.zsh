...
cp "$bundle_root/apply_checkpoint_239.zsh" "$target_root/apply_checkpoint_239.zsh"
chmod +x \
  "$target_root/apply_checkpoint_239.zsh" \
  "$target_root/scripts/check_cp239_graph_fundamental_subspaces.zsh" \
  "$target_root/scripts/render_cp239_graph_fundamental_subspaces.zsh"

print -- "Checkpoint 239 installed in $target_root"
print -- "Activate seeingla-manim021, then run scripts/check_cp239_graph_fundamental_subspaces.zsh"
