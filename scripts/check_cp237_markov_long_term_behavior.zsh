...
if sys.version_info[:2] != (3, 12):
    raise SystemExit(f"CP237 requires Python 3.12; found {sys.version.split()[0]}")
PY
python -m manim --version | grep -q "v0.21.0" || {
  print -u2 -- "CP237 requires Manim Community v0.21.0."
  exit 1
}
...
print -- "Checkpoint 237 checks passed on Python 3.12 / Manim 0.21.0."
